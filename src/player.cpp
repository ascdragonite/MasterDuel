...
void Player :: loadDeckDarkMagician(){
    ...
    deck.push_back(new SpellCard("Apprentice Helper", "Special Summon 1 Magicians Apprentice from your deck in faceup defend position.Then, add 1 monster that mentions “Dark Magician” from your deck to your hand."));
    deck.push_back(new SpellCard("Chaos Magic", "If you control a monster that mentions Dark Magician: Add 1 Dark Magician of Chaos and 1 Black Luster Soldier from your deck to your hand.."));
    deck.push_back(new SpellCard("Illusion Magic", "Discard 1 card: Add 2 monster cards from your deck to your hand, each of which mentions Dark Magician in their description. You can only activate 1 Secrets of the Dark Circle per turn."));
    deck.push_back(new SpellCard("Illusion Magic", "Discard 1 card: Add 2 monster cards from your deck to your hand, each of which mentions Dark Magician in their description. You can only activate 1 Secrets of the Dark Circle per turn."));
    deck.push_back(new SpellCard("Illusion Magic", "Discard 1 card: Add 2 monster cards from your deck to your hand, each of which mentions Dark Magician in their description. You can only activate 1 Secrets of the Dark Circle per turn."));
    deck.push_back(new SpellCard("Enternal Soul", "Put 1 card from your hand to the deck special Summon up to 2 monsters from your deck in face-up Defense Position, each of which mentions “Dark Magician” in their description.If you summon both Magicians Rod” and “Magicians Soul this way, draw 2 cards.You can only activate 1 “Enternal Soul” per turn."));
    deck.push_back(new SpellCard("Enternal Soul", "Put 1 card from your hand to the deck special Summon up to 2 monsters from your deck in face-up Defense Position, each of which mentions “Dark Magician” in their description.If you summon both Magicians Rod” and “Magicians Soul this way, draw 2 cards.You can only activate 1 “Enternal Soul” per turn."));
    deck.push_back(new SpellCard("Enternal Soul", "Put 1 card from your hand to the deck special Summon up to 2 monsters from your deck in face-up Defense Position, each of which mentions “Dark Magician” in their description.If you summon both Magicians Rod” and “Magicians Soul this way, draw 2 cards.You can only activate 1 “Enternal Soul” per turn."));
